...
void main() {
  ...
  group('支付流程測試', () {
    ...
    testWidgets('應該能夠訪問支付頁面', (tester) async {
      try {
    ...
    testWidgets('應該能夠檢查支付表單', (tester) async {
      try {
        final response = await http.get(Uri.parse(baseUrl));
        expect(response.statusCode, 200);
    ...
    testWidgets('應該能夠檢查支付方式選項', (tester) async {
      try {
        final response = await http.get(Uri.parse(baseUrl));
        expect(response.statusCode, 200);
    ...
    testWidgets('應該能夠檢查支付安全措施', (tester) async {
      try {
        final response = await http.get(Uri.parse(baseUrl));
        expect(response.statusCode, 200);
    ...
    testWidgets('應該能夠模擬支付流程', (tester) async {
      try {
        final response = await http.get(Uri.parse(baseUrl));
        expect(response.statusCode, 200);
    ...
    testWidgets('應該能夠檢查支付確認頁面', (tester) async {
      try {
        final response = await http.get(Uri.parse(baseUrl));
        expect(response.statusCode, 200);
